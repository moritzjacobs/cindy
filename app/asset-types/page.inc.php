...
class Page {
	...
	function parse_template() {
		$parse_data = TemplateParser::parse($this->data, file_get_contents($this->template_file));
		$pre_data = GlobalParser::parse($parse_data);
		$data = TemplateParser::parse($this->data, $pre_data);
		# post-parse JSON
